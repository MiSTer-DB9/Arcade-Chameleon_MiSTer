...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Chameleon_MiSTer.git"
CORE_NAME=(Arcade-Chameleon)
...
UPSTREAM_CORE_NAME=(Arcade-Chameleon)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-Chameleon.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Chameleon.rbf)
